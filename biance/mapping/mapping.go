...
func MappingWithBUSDOrUSDT(client biance.Client, priceUrl string, isReverse bool, paris ...*Pair) ([]Mapped, error) {
	var editPair = paris
	...
	return mapping(prices, isReverse, paris...), nil
}

func Mapping(client biance.Client, priceUrl string, isReverse bool, paris ...*Pair) ([]Mapped, error) {
...
func mapping(prices []price.Price, isReverse bool, pairs ...*Pair) []Mapped {
