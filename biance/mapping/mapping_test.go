...
func TestMappingWithBUSDOrUSDT(t *testing.T) {
	TokenValueRaw := "MDX:11.18 AERGO:4.02 OCEAN:3.38 PYR:3.21 BCH:2.49 COTI:2.47 WAVES:2.43 ALPINE:2.42 WTC:2.38 FLM:2.36 NKN:2.21 AMB:2.21 AXS:2.20 REEF:2.09 BTTC:2.08 ASR:2.08 GAL:2.06 CREAM:2.06 ETH:2.02"
